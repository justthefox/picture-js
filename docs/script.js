...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.js-feedback-slider-item', '', '.js-main-prev', '.js-main-next');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.js-main-slider-item', 'vertical');
});
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var openByScroll = function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      !btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeight && document.querySelector(selector).click();
    });
  };

  bindModal('.js-button-design', '.js-popup-design', '.js-popup-design .js-popup-close');
  bindModal('.js-button-consultation', '.js-popup-consultation', '.js-popup-consultation .js-popup-close');
  bindModal('.js-fixed-gift', '.js-popup-gift', '.js-popup-gift .js-popup-close', true);
  openByScroll('.js-fixed-gift');
...
/* harmony default export */ __webpack_exports__["default"] = (function (slides) {
  ...
  var interval = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 5000;
  var paused = null;
  var slideIndex = 1;
  ...
  var addSlides = function addSlides(n) {
